...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/despliegue.css">
...
<body>
    <a href="carrito.php" class="btn-flotante" id="btnCarrito"><i class="fa-solid fa-cart-shopping"></i></a>
    <header class="header">
        <div class="menu container">
            <a href="inicio.php" class="logo">Platillos & Bebidas</a>
    ...
    <section class="our" id="sevicio-section">
        <div class="container">
    ...
    <section class="horario" id="horario-section">
